...
#import "Build_Shoulders_5_TVC.h"
#import "UITableViewController+Database.h"
#import "UITableViewController+Design.h"
#import "DataNavController.h"

@interface Build_Shoulders_5_TVC ()

@end

@implementation Build_Shoulders_5_TVC
...
- (void)loadArrays {
    ...
    self.Titles = @[@"6-Way Shoulder",
                    @"Abs"];
    
    NSArray * repNameArray1 = @[@"12",
                                @"8",
                                @"",
                                @"",
                                @"",

...
- (void)configureButtonBorder {
    ...
    self.decreaseSessionButton.backgroundColor = lightOrange;
    self.decreaseSessionButton.layer.borderWidth = 1.0f;
    self.decreaseSessionButton.layer.borderColor = [orange CGColor];
    ...
    self.increaseSessionButton.backgroundColor = lightOrange;
    self.increaseSessionButton.layer.borderWidth = 1.0f;
    self.increaseSessionButton.layer.borderColor = [orange CGColor];
    ...
    self.resetAllDataButton.backgroundColor = lightOrange;
    self.resetAllDataButton.layer.borderWidth = 1.0f;
    self.resetAllDataButton.layer.borderColor = [orange CGColor];
    ...
    self.resetCurrentSessionDataButton.backgroundColor = lightOrange;
...
- (void)findiCloudStatus {
    ...
    if ([CoreDataHelper sharedHelper].iCloudEnabledByUser) {
        ...
        self.iCloudAppStatusLabel.text = @"NO.  Change in Device Settings -> 90 DWT BB";
    }
}

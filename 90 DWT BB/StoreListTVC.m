...
- (void)reload {
    ...
    [[_0DWTBBIAPHelper sharedInstance] requestProductsWithCompletionHandler:^(BOOL success, NSArray *products) {
        if (success) {
            _products = products;
            [self.tableView reloadData];
        }
...
- (void)buyButtonTapped:(id)sender {
    ...
    [[_0DWTBBIAPHelper sharedInstance] buyProduct:product];
}

- (void)restoreTapped:(id)sender {
    [[_0DWTBBIAPHelper sharedInstance] restoreCompletedTransactions];
}

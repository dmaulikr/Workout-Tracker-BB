...
#import "Bulk_Arms_1_TVC.h"
#import "UITableViewController+Database.h"
#import "UITableViewController+Design.h"
#import "DataNavController.h"

@interface Bulk_Arms_1_TVC ()

@end

@implementation Bulk_Arms_1_TVC
...
- (void)loadArrays {
    ...
    NSArray *repArraySection1 = @[repNameArray3];
    
    NSArray *repArraySection2 = @[repNameArray1];
    
    NSArray *repArraySection3 = @[repNameArray4];
    ...
    NSArray *repArraySection7 = @[repNameArray2];

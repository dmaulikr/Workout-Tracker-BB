...
- (void)addDeleteDate:(UITableViewCell*)argCell {
    ...
    if ([mainAppDelegate.request isEqualToString:@"Not Completed"]) {
        ...
        if ([((DataNavController *)self.parentViewController).routine isEqualToString:@"Bulk"]) {
            ...
            NSArray *nameArray = mainAppDelegate.build_WorkoutNameArray[mainAppDelegate.weekArrayPositionValue];
            NSArray *indexArray = mainAppDelegate.build_WorkoutIndexArray[mainAppDelegate.weekArrayPositionValue];
            ...
            // Tone
            NSArray *nameArray = mainAppDelegate.tone_WorkoutNameArray[mainAppDelegate.weekArrayPositionValue];
            NSArray *indexArray = mainAppDelegate.tone_WorkoutIndexArray[mainAppDelegate.weekArrayPositionValue];

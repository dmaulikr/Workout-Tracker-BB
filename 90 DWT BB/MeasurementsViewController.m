...
- (void)emailMeasurements {
    ...
    if ([MFMailComposeViewController canSendMail]) {
        ...
        if ([objects count] >= 1) {
            ...
            NSString *fileName = [NSString stringWithFormat:@"90 DWT BB %@ Measurements - Session %@.csv", self.navigationItem.title, currentSessionString];

...
- (void)emailPhotos
{
    ...
    if ([MFMailComposeViewController canSendMail]) {
        ...
        if ([self.navigationItem.title isEqualToString:@"All"]) {
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT BB All Photos - Session %@", currentSessionString];
        ...
        // FRONT PHOTOS
            ...
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT BB Front Photos - Session %@", currentSessionString];
            [mailComposer setSubject:emailTitle];
        ...
        // SIDE PHOTOS
            ...
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT BB Side Photos - Session %@", currentSessionString];
            [mailComposer setSubject:emailTitle];
        ...
        // BACK PHOTOS
            ...
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT BB Back Photos - Session %@", currentSessionString];
            [mailComposer setSubject:emailTitle];
